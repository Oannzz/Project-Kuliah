...
(1, 'EMR-0001', 1, 1, 'emergency', 'Ada gedung terbakar kira-kira 20 lantai, asap sangat tebal terlihat dari kejauhan', 'Jl. Gotong Royong No. 29, Jakarta Pusat', NULL, 'ditangani', '2026-05-06 08:30:00', '2026-06-09 09:24:19', '2026-06-24 13:00:10', 123, 2345),
(2, 'NEM-0001', 2, 1, 'non_emergency', 'Kunci masuk ke selokan di depan rumah sudah rusak 3 hari, berbahaya untuk anak', 'Jl. Merpati No. 15, Jakarta Barat', NULL, 'ditolak', '2026-05-03 14:00:00', '2026-06-09 09:24:19', '2026-06-24 13:00:14', 212, 222),
(3, 'EMR-0002', 3, 2, 'emergency', 'Ular besar masuk ke dalam rumah melalui saluran pembuangan, warga panik', 'Jl. Srikandi No. 7, Jakarta Selatan', NULL, 'selesai', '2026-05-02 10:15:00', '2026-06-09 09:24:19', '2026-06-24 13:00:20', 33, 134),
(4, 'EMR-0003', 1, 1, 'emergency', 'Kebakaran di warung makan pinggir jalan, api sudah merambat ke kios sebelah', 'Jl. Pahlawan No. 44, Jakarta Pusat', NULL, 'masuk_sistem', '2026-05-07 07:45:00', '2026-06-09 09:24:19', '2026-06-24 13:00:25', 111, 78),
(5, 'EMR-8478', 5, NULL, NULL, 'asfgdfghsdhsdhsdgf', 'DFASDFASDFASDFASDFASDF', NULL, 'masuk_sistem', '2026-06-04 02:38:00', '2026-06-24 19:38:48', '2026-06-24 19:38:48', -6.417510902886356, 106.94366455078126);
...
--
ALTER TABLE `form_pengaduan`
  MODIFY `id_form_pengaduan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

...
import com.mycompany.tugas_uas_smtr2.DetailPengaduanTerbaruInstansi;
...
public class isilaporanhasilpenangananInstansi extends javax.swing.JFrame {
    ...
    private java.io.File selectedFotoFile;
...
// TAMBAHKAN INI: Untuk menampung path file pilihan JFileChooser sebelum dikirim
    ...
    private void tampilkanPreviewFoto(java.io.File file) {
        try {
            java.awt.image.BufferedImage img = javax.imageio.ImageIO.read(file);
            if (img != null) {
                int targetW = lbl_preview.getWidth() > 0 ? lbl_preview.getWidth() : 300;
                int targetH = lbl_preview.getHeight() > 0 ? lbl_preview.getHeight() : 300;
                java.awt.Image scaled = img.getScaledInstance(targetW, targetH, java.awt.Image.SCALE_SMOOTH);
                lbl_preview.setIcon(new javax.swing.ImageIcon(scaled));
                lbl_preview.setText("");
            } else {
                lbl_preview.setIcon(null);
                lbl_preview.setText("Format tidak didukung");
            }
        } catch (Exception e) {
            lbl_preview.setIcon(null);
            lbl_preview.setText("Gagal memuat gambar");
            e.printStackTrace();
        }
    }
    ...
    private void initComponents() {
        ...
        lbl_preview.setPreferredSize(new java.awt.Dimension(300, 300));
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(62, 62, 62)
                                        .addComponent(lbl_preview, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void jFileChooser1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFileChooser1ActionPerformed
        ...
        if (JFileChooser.APPROVE_SELECTION.equals(evt.getActionCommand())) {
            ...
            if (selectedFile != null) {
                tampilkanPreviewFoto(selectedFile);
            }
        }
    ...
    private void btn_kirimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_kirimActionPerformed
        ...
        try {
            ...
            String sqlCekKlasifikasi = "SELECT klasifikasi, id_operator FROM form_pengaduan WHERE kode_pengaduan = ?";
            ...
            String jenisKlasifikasi = ""; // Default cadangan
            if (rsCekKla.next()) {
                jenisKlasifikasi = rsCekKla.getString("klasifikasi");
                idOperatorLogedIn = rsCekKla.getInt("id_operator");// mengambil 'emergency' atau 'non_emergency'
            } else {
            ...
            String prefix = "NE-"; // Default non_emergency
            if (jenisKlasifikasi.equalsIgnoreCase("emergency")) {
                prefix = "EM-";
            }

            // Hitung jumlah laporan dengan prefix yang sama untuk menentukan nomor urut berikutnya
            String sqlHitung = "SELECT COUNT(*) FROM laporan_penanganan WHERE kode_laporan LIKE ?";
            java.sql.PreparedStatement psHitung = conn.prepareStatement(sqlHitung);
            psHitung.setString(1, prefix + "%");
            java.sql.ResultSet rsHitung = psHitung.executeQuery();

            int urutanBerikutnya = 1;
            if (rsHitung.next()) {
                urutanBerikutnya = rsHitung.getInt(1) + 1;
            }
            rsHitung.close();
            psHitung.close();

            // Format menjadi 4 digit (contoh: EM-0001, NE-0002)
            kodeLaporanOtomatis = prefix + String.format("%04d", urutanBerikutnya);
            // =======================================================================
            ...
            if (rows > 0) {
                ...
                javax.swing.JOptionPane.showMessageDialog(null,
                        "Laporan berhasil dikirim!: " + kodeLaporanOtomatis);
                area_detail.setText("");
                area_alamat.setText("");
